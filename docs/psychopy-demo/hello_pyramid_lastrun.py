...
This experiment was created using PsychoPy3 Experiment Builder (v2024.1.4),
    on Mon 06 May 2024 01:29:43 PM EDT
...
expName = 'hello_pyramid'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/home/ninjaben/codin/gold-lab/pyramid/docs/tutorial/hello_pyramid_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=2.0, method='random', 
        ...
        trialList=data.importConditions('hello_pyramid_conditions.csv'),
    ...
    for thisTrial in trials:
        ...
        cue.setText(cue_text)
        # keep track of which components have finished
        trialComponents = [left, right, mouse, prompt, cue]
        ...
        while continueRoutine:
            ...
            if left.status == NOT_STARTED and tThisFlip >= 1-frameTolerance:
            ...
            if right.status == NOT_STARTED and tThisFlip >= 1-frameTolerance:
                # keep track of start time/frame for later
            ...
            if prompt.status == STARTED:
                ...
                if tThisFlipGlobal > prompt.tStartRefresh + 1.0-frameTolerance:
