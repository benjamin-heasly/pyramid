...
def test_reader_sync_registry_closest():
    ...
    sync_registry.record_event("bar", 0.91)
    assert sync_registry.get_drift("ref", pairing_strategy="closest") == 0
    assert sync_registry.get_drift("foo", pairing_strategy="closest") == 1.11 - 1.0
    assert sync_registry.get_drift("bar", pairing_strategy="closest") == 0.91 - 1.0
    ...
    sync_registry.record_event("foo", 2.12)
    assert sync_registry.get_drift("ref", pairing_strategy="closest") == 0
    assert sync_registry.get_drift("foo", pairing_strategy="closest") == 2.12 - 2.0
    assert sync_registry.get_drift("bar", pairing_strategy="closest") == 0.91 - 1.0
    ...
    sync_registry.record_event("bar", 2.93)
    assert sync_registry.get_drift("ref", pairing_strategy="closest") == 0
    assert sync_registry.get_drift("foo", pairing_strategy="closest") == 3.13 - 3.0
    assert sync_registry.get_drift("bar", pairing_strategy="closest") == 2.93 - 3.0
    ...
    sync_registry.record_event("bar", 4.95)
    assert sync_registry.get_drift("ref", pairing_strategy="closest") == 0
    assert sync_registry.get_drift("foo", pairing_strategy="closest") == 5.15 - 5.0
    assert sync_registry.get_drift("bar", pairing_strategy="closest") == 4.95 - 5.0
